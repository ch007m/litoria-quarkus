...
See link:slideshow-tokens.html[Slideshow Token Reference] for the full token reference.
...
For the full token reference including all parameters, resolution order, and before/after examples, see link:slideshow-tokens.html[Slideshow Token Reference].
